...
package net.mcreator.sussyballs.world.biome;
...
import net.mcreator.sussyballs.entity.HitlerEntity;
import net.mcreator.sussyballs.block.AmongrassBlock;
import net.mcreator.sussyballs.SussyBallsModElements;

import com.google.common.collect.ImmutableList;

@SussyBallsModElements.ModElement.Tag
public class AmogusForestBiome extends SussyBallsModElements.ModElement {
	public static Biome biome;
	public AmogusForestBiome(SussyBallsModElements instance) {
		super(instance, 15);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777216).setWaterColor(-16764058).setWaterFogColor(-16764109)
						.withSkyColor(-16777216).withFoliageColor(-16764160).withGrassColor(-65536)
						.setMusic(new BackgroundMusicSelector((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("sussy_balls:amongustrapremix")), 12000, 24000, true))
						.setParticle(new ParticleEffectAmbience(ParticleTypes.CRIMSON_SPORE, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(AmongrassBlock.block.getDefaultState(),
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(HitlerEntity.entity, 20, 1, 1));
				...
				event.getRegistry().register(biome.setRegistryName("sussy_balls:amogus_forest"));
			}
		}
	}
	@Override
