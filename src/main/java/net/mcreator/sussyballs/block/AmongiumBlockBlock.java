...
public class AmongiumBlockBlock extends SussyBallsModElements.ModElement {
	@ObjectHolder("sussy_balls:amongium_block")
	public static final Block block = null;
	public AmongiumBlockBlock(SussyBallsModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amongium_block");
		}
